...
use crate::gui::styles::style_constant::{
    OUTFIT_BLACK, OUTFIT_BOLD, OUTFIT_EXTRABOLD, OUTFIT_EXTRALIGHT, OUTFIT_LIGHT, OUTFIT_MEDIUM,
    OUTFIT_REGULAR, OUTFIT_SEMIBOLD, OUTFIT_THIN, RALEWAY_BLACK, RALEWAY_BLACK_ITALIC,
    RALEWAY_BOLD, RALEWAY_BOLD_ITALIC, RALEWAY_EXTRA_BOLD, RALEWAY_EXTRA_BOLD_ITALIC,
    RALEWAY_EXTRA_LIGHT, RALEWAY_EXTRA_LIGHT_ITALIC, RALEWAY_ITALIC, RALEWAY_LIGHT,
    RALEWAY_LIGHT_ITALIC, RALEWAY_MEDIUM, RALEWAY_MEDIUM_ITALIC, RALEWAY_REGULAR,
    RALEWAY_SEMI_BOLD, RALEWAY_SEMI_BOLD_ITALIC, RALEWAY_THIN, RALEWAY_THIN_ITALIC,
};
